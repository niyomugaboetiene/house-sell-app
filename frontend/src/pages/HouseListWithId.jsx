            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    {house.length || house.image.length > 0 ? (
                        ...
                        />
                 <button
                    className="absolute top-130 left-84 bg-amber-50 p-2 rounded-full hover:bg-amber-100 transition duration-200 hover:scale-105"
                      onClick={() =>
                   ...
                   >
                       ...
                       <button
                            className="absolute top-130 left-222 bg-amber-50 p-2 rounded-full hover:bg-amber-100 transition duration-200 hover:scale-105"
                            onClick={() =>
                            setCurrentImageIndex(
