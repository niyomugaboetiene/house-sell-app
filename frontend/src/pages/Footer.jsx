            ...
            <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <Link 
                            className="p-3 bg-gray-100 rounded-md hover:bg-blue-400 hover:text-white transition-colors group flex justify-center" 
                        ...
                        <Link 
                            className="p-3 bg-gray-100 rounded-md hover:bg-blue-700 hover:text-white transition-colors group flex justify-center" 
